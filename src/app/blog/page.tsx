...
const posts = [
  ...
  {
    slug: "redact-medical-records",
    title: "How to Redact Medical Records — HIPAA Compliant Redaction Guide",
    excerpt: "Learn how to properly redact medical records in compliance with HIPAA. Free online tool supports PDF, Word, and Excel for healthcare document redaction.",
    author: "Redactly Team",
    date: "2026-05-14",
    category: "Healthcare",
  },
  {
    slug: "redact-excel-financial-data",
    title: "How to Remove Confidential Financial Data from Excel Before Sharing",
    excerpt: "Learn how to redact sensitive financial data from Excel spreadsheets before emailing clients or sharing externally. Free online tool.",
    author: "Redactly Team",
    date: "2026-05-13",
    category: "Guide",
  },
  {
    slug: "redact-bank-statement-rental",
    title: "How to Redact a Bank Statement for a Rental Application",
    excerpt: "Learn why apartments ask for bank statements, what information to redact, and how to redact a bank statement for a rental application using Redactly's free tool.",
    author: "Redactly Team",
    date: "2026-05-12",
    category: "Guide",
  },
  {
    slug: "redact-id-documents",
    title: "How to Redact Personal Information from ID Documents Before Sharing",
    excerpt: "Learn how to safely redact passports, driver's licenses, and ID cards before sharing online. Free tool supports PDF, Word, and Excel.",
    author: "Redactly Team",
    date: "2026-05-12",
    category: "Guide",
  },
